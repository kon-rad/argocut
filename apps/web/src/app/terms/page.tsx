...
import { ISSUES_URL, SOCIAL_LINKS } from "@/site/social";

export const metadata: Metadata = {
	title: "Terms of Service - ArgoCut",
	description:
		"ArgoCut's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
	openGraph: {
		title: "Terms of Service - ArgoCut",
		description:
			"ArgoCut's Terms of Service. Fair, transparent terms for our free and open-source video editor.",
		...
		>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					...
					<li>No watermarks, no licensing restrictions from ArgoCut</li>
				</ul>
			</section>

			<section className="flex flex-col gap-3">
				<h2 className="text-2xl font-semibold">How You Can Use ArgoCut</h2>
				<p>ArgoCut is free for personal and commercial use. You can:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
						Create videos for personal, educational, or commercial purposes
					</li>
					<li>Use ArgoCut for client work and paid projects</li>
					<li>Share and distribute videos created with ArgoCut</li>
					<li>
						Modify and distribute the ArgoCut software (under MIT license)
					</li>
				</ul>
				<p>
					You&apos;re responsible for how you use ArgoCut and the content you
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					...
					are optional - you can use ArgoCut without them.
				</p>
			</section>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ArgoCut does not currently require an account. The service is provided
			...
			<section className="flex flex-col gap-3">
				...
				<p>Because ArgoCut is open source, you have additional rights:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>Review our code to see exactly how we handle your data</li>
					<li>Self-host ArgoCut on your own servers</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ArgoCut is provided free of charge. To the extent permitted by law:
				</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>We may update ArgoCut and these terms:</p>
				<ul className="list-disc space-y-2 pl-6">
			...
			<section className="flex flex-col gap-3">
				...
				<p>You can stop using ArgoCut at any time:</p>
				<ul className="list-disc space-y-2 pl-6">
