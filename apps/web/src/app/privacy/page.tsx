...
export const metadata: Metadata = {
	title: "Privacy Policy - ArgoCut",
	description:
		"Learn how ArgoCut handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	openGraph: {
		title: "Privacy Policy - ArgoCut",
		description:
			"Learn how ArgoCut handles your data and privacy. Our commitment to protecting your information while you edit videos.",
	...
	return (
		...
		>
				...
				>
					...
					<AccordionContent>
						...
						<ol className="list-decimal space-y-2 pl-6">
							...
							<li>
								ArgoCut does not currently require an account or login
							</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ArgoCut does not currently offer user accounts, login, or Google
					sign-in.
				</p>
				<p>
			...
			<section className="flex flex-col gap-3">
				...
				<p>ArgoCut integrates with these services:</p>
				<ul className="list-disc space-y-2 pl-6">
					<li>
			...
			<section className="flex flex-col gap-3">
				...
				<ul className="list-disc space-y-2 pl-6">
					<li>No account is required to use ArgoCut today</li>
			...
			<section className="flex flex-col gap-3">
				...
				<p>
					ArgoCut is completely open source. You can review our code, see
