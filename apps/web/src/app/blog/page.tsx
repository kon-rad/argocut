...
export const metadata: Metadata = {
	title: "Blog - ArgoCut",
	description:
		"Read the latest news and updates about ArgoCut, the free and open-source video editor.",
	openGraph: {
		title: "Blog - ArgoCut",
		description:
			"Read the latest news and updates about ArgoCut, the free and open-source video editor.",
...
export default async function BlogPage() {
	...
	return (
		<BasePage
			title="Blog"
			description="Read the latest news and updates about ArgoCut, the free and open-source video editor."
		>
