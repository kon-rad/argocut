...
export const metadata: Metadata = {
	title: "Changelog - ArgoCut",
	description: "What's new in ArgoCut",
	openGraph: {
		title: "Changelog - ArgoCut",
		description: "Every update, improvement, and fix to ArgoCut — documented.",
		type: "website",
		images: [
			{
...
export default function ChangelogPage() {
	...
	return (
		<BasePage title="Changelog" description="See what's new in ArgoCut">
