				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title="Welcome to ArgoCut Beta! 🎉" />
							<Description description="You're among the first to try ArgoCut - the fully open source CapCut alternative." />
						</div>
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							...
							<Description description="If you're curious, check out the roadmap [here](/roadmap)" />
						</div>
						<NextButton onClick={handleNext}>Next</NextButton>
					</div>
				);
				...
				return (
					<div className="space-y-5">
						<div className="space-y-3">
							<Title title={getStepTitle()} />
							<Description
								description={`Found a bug or want a feature? Open an issue on [GitHub](${SOCIAL_LINKS.github}/issues).`}
							/>
						</div>
